...
class Ui_NotesWidget(object):
    def setupUi(self, NotesWidget):
        ...
        #NotesWidget.setCentralWidget(self.centralWidget)
    ...
    def retranslateUi(self, NotesWidget):
        ...
        self.closeButton.setText(_translate("NotesWidget", "×"))
        self.moreButton.setText(_translate("NotesWidget", "＋"))
